...
export default class BitloopsVisitor extends BitloopsParserVisitor {
  ...
  private mergeSourceElements(children: any): TModule {
    const sourceElementsResult = children.map((c: any) => c[0]);
    return sourceElementsResult.reduce((acc: any, sourceElement: any) => {
  ...
  visitRegularErrorTypeEvaluationString(ctx: BitloopsParser.RegularErrorTypeEvaluationStringContext) {
  ...
  visitTemplateStringLiteral(ctx: BitloopsParser.TemplateStringLiteralContext) {
    ...
    const value = stringChars.map((sc: any) => sc.getText()).join('');
    return {
      type: 'backTickString',
      value: value,
    };
  ...
  visitDomainEvaluationInputFieldList(ctx: BitloopsParser.DomainEvaluationInputFieldListContext): TEvaluationFields {
    return this.visit(ctx.evaluationFieldList());
  }

  visitDomainEvaluationInputRegular(ctx: BitloopsParser.DomainEvaluationInputRegularContext): TRegularEvaluation {
  ...
  visitRestControllerExecuteDeclaration(ctx: BitloopsParser.RestControllerExecuteDeclarationContext): {
  ...
  visitGraphQLOperationTypeAssignment(ctx: BitloopsParser.GraphQLOperationTypeAssignmentContext): TGraphQLOperation {
    return ctx.graphQLOperation().getText();
  }

  visitGraphQLOperationInputTypeAssignment(ctx: BitloopsParser.GraphQLOperationInputTypeAssignmentContext): string {
  ...
  visitBuiltInClassEvaluation(ctx: BitloopsParser.BuiltInClassEvaluationContext): TBuiltInClassEvaluation {
  ...
  visitDomainConstructorDeclaration(ctx: BitloopsParser.DomainConstructorDeclarationContext): TEntityCreate {
  ...
  visitDomainConstDeclarationList(ctx: BitloopsParser.DomainConstDeclarationListContext): TConstDeclarationValue[] {
    return domainConstDeclarationListVisitor(this, ctx);
  }

  visitDomainConstDeclaration(ctx: BitloopsParser.DomainConstDeclarationContext): TConstDeclaration {
  ...
  visitPrivateMethodDeclarationList(ctx: BitloopsParser.PrivateMethodDeclarationListContext): TValueObjectMethods {
  ...
  visitReturnPrivateMethodType(ctx: BitloopsParser.ReturnPrivateMethodTypeContext): TReturnType | TOkErrorReturnType {
  ...
  visitRepoExtendsList(ctx: BitloopsParser.RepoExtendsListContext) {
    return this.visitChildren(ctx).filter((listItem: any) => listItem !== undefined);
  }

  visitRepoPortExtendableIdentifierList(ctx: BitloopsParser.RepoPortExtendableIdentifierListContext) {
    return this.visitChildren(ctx)[0];
  }
